import { colorText } from "./calm-terminal-palette.ts";

export interface GateStatusViewResult {
  name?: string;
  passed?: boolean;
  required?: boolean;
...
interface GateStatusViewOptions {
  color?: boolean;
}
...
export function renderGateStatus(
  gateResults: readonly GateStatusViewResult[] | undefined = [],
  { color = true }: GateStatusViewOptions = {},
): string[] {
